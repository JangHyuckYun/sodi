...
export class Board {
  ...
  @Column({ name: 'board_longitude', comment: '게시글의 위치' })
  longitude: number;
  ...
  @Column({ name: 'board_image_2', comment: '게시글의 이미지 2 ' })
  image2: string;

  @Column({ name: 'board_image_3', comment: '게시글의 이미지 3 ' })
  image3: string;

  @Column({ name: 'board_image_4', comment: '게시글의 이미지 4 ' })
  image4: string;

  @Column({ name: 'board_image_5', comment: '게시글의 이미지 5 ' })
  image5: string;
